...
# import tiktoken  # Architecture compatibility issue on ARM64 Mac
import math
...
class ContextBuilder:
    ...
    def __init__(
        ...
        # self._encoding = tiktoken.get_encoding("cl100k_base")  # Architecture compatibility issue
...
def count_tokens(text: str) -> int:
    """计算文本token数（使用备用方案）"""
    # tiktoken架构兼容性问题，使用字符估算
    # 中文文本：1 token ≈ 1.5-2 字符；英文文本：1 token ≈ 4 字符
    # 混合文本使用中间值：1 token ≈ 2.5 字符
    if not text:
        return 0
